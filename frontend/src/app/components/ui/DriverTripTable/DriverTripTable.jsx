...
export default function DriverTripTable({ trips = [] }) {
  ...
  const InputCell = ({ row, field, bg = "bg-content1" }) => (
    <input
      type="number"
      ...
      <table className="min-w-full text-xs border-collapse">
        <thead>
          ...
          <tr className="bg-content2 text-center font-bold border-b border-divider text-[10px] md:text-xs">
            ...
            <th className="border p-1 bg-red-400" rowSpan={3}>
              PAGO
            </th>
            <th className="border p-1 bg-yellow-200" rowSpan={3}>
              SUBTOTALES
            </th>
          </tr>
          {/* Fila 2 */}
        ...
        <tbody>
          {data.map((row) => (
            <tr key={row.id} className="hover:bg-content2/50">
              ...
              <td className="border p-0">
                <InputCell row={row} field="tarifaTotalAr" />
              </td>
              <td className="border p-0">
                <InputCell row={row} field="tarifaChoferPorcentaje" />
              </td>
              <td className="border p-0">
                <InputCell row={row} field="tarifaTotalUsd" />
              </td>
              <td className="border p-0">
                <InputCell row={row} field="tarifaChoferUsd" />
              </td>
              <td className="border p-0">
                <InputCell row={row} field="tarifaChoferUsdAr" />
              </td>
              <td className="border p-0">
                <InputCell row={row} field="estadiaCh" />
              </td>
              <td className="border p-0">
                <InputCell row={row} field="estadiaAr" />
              </td>
              ...
              {/* VIATICOS CHILE */}
              <td className="border p-0">
                <InputCell row={row} field="viaticoChileno" />
              </td>
              <td className="border p-0">
                <InputCell row={row} field="peajeCh" />
              </td>
              <td className="border p-0">
                <InputCell row={row} field="devolCh" />
              </td>
              <td className="border px-2 py-1 text-right font-bold bg-default-200">
              ...
              {/* VIATICOS ARG */}
              <td className="border p-0">
                <InputCell row={row} field="viaticoArgentino" />
              </td>
              <td className="border p-0">
                <InputCell row={row} field="peajeAr" />
              </td>
              <td className="border p-0">
                <InputCell row={row} field="devolAr" />
              </td>
              <td className="border px-2 py-1 text-right font-bold bg-default-200">
              ...
              {/* PAGO / SUBTOTAL */}
              <td className="border p-0 bg-red-500/10">
                <InputCell row={row} field="pago" bg="bg-red-500/5" />
              </td>
          ...
          <tr className="font-bold bg-default-200 text-[10px] md:text-xs">
            ...
            {/* FINAL */}
            <td className="border p-1 text-right bg-red-500/15">
              {data.reduce((a, b) => a + (b.pago || 0), 0).toLocaleString()}
            </td>
            <td className="border p-1 text-right bg-yellow-500/20">
              {data.reduce((a, b) => a + (b.subtotal || 0), 0).toLocaleString()}
            </td>
          </tr>
        </tbody>
      </table>
