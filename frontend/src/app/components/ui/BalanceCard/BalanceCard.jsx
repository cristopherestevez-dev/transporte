...
export default function BalanceCard({
  cobranzas = { nacionales: [], internacionales: [] },
    ...
    <div className="space-y-6">
      ...
      <div className="bg-content1 rounded-xl shadow-lg border border-divider p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Balance Neto */}
          <div
            className={`rounded-xl p-6 text-center ${isPositiveBalance ? "bg-green-50 dark:bg-green-900/20 border-2 border-green-500" : "bg-red-50 dark:bg-red-900/20 border-2 border-red-500"}`}
          >
            ...
            <p
              className={`text-3xl font-bold ${isPositiveBalance ? "text-green-600" : "text-red-600"}`}
            >
              ${balanceNeto.toLocaleString()}
            </p>
            <p className="text-xs text-default-400 mt-1">(Cobrado - Pagado)</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-content1 rounded-xl shadow border border-divider p-6">
          <h3 className="text-lg font-bold text-foreground mb-4">Cobranzas</h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
              ...
              <span className="font-bold text-green-600">
                ${cobranzasTotals.cobrado.toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between items-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
              ...
              <span className="font-bold text-yellow-600">
                ${cobranzasTotals.pendiente.toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
              ...
              <span className="font-bold text-red-600">
                ${cobranzasTotals.vencido.toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between items-center p-3 bg-content2 rounded-lg border-t-2 border-brand-navy">
              ...
              <span className="font-bold text-foreground">
                ${cobranzasTotals.total.toLocaleString()}
              </span>
            </div>
          </div>
        </div>
        ...
        {/* Resumen Pagos */}
        <div className="bg-content1 rounded-xl shadow border border-divider p-6">
          <h3 className="text-lg font-bold text-foreground mb-4">Pagos</h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
              <div className="flex items-center gap-2">
                <HiCheckCircle className="text-green-500" size={20} />
              ...
              <span className="font-bold text-green-600">
                ${pagosTotals.pagado.toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between items-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
              <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-yellow-600">
                ${pagosTotals.pendiente.toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
              <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-red-600">
                ${pagosTotals.vencido.toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between items-center p-3 bg-content2 rounded-lg border-t-2 border-brand-navy">
              <span className="text-sm font-bold text-foreground">
              ...
              <span className="font-bold text-foreground">
                ${pagosTotals.total.toLocaleString()}
              </span>
            </div>
          </div>
        </div>
